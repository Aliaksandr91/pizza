...
import {addItem, ItemType, selectCartItemById} from "../../redux/slices/cartSlice";
import {Link} from "react-router-dom";

type PizzaBlockPropsTypes = {
    id: string
    title: string
    price: number
    imageUrl: string
...
export const PizzaBlock: React.FC<PizzaBlockPropsTypes> = ({id, title, price, imageUrl, sizes, types}) => {
