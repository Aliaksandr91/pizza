...
export const CartItem: React.FC<CartItemPropsType> = ({id, size, title, type, price, count, imageUrl}) => {
    ...
    const onClickRemove = () => {
        if (window.confirm('Are you sure want to remove?')) dispatch(removeItem(id))
    }
